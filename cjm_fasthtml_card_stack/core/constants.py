...
# %% auto #0
__all__ = ['CardRole', 'SCROLL_THRESHOLD', 'NAVIGATION_COOLDOWN', 'TRACKPAD_COOLDOWN', 'DEFAULT_VISIBLE_COUNT',
           'DEFAULT_CARD_WIDTH', 'DEFAULT_CARD_SCALE', 'width_storage_key', 'scale_storage_key',
           'card_count_storage_key', 'auto_count_storage_key']
